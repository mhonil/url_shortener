    ...
    <header>
        <nav class="bg-white border-gray-200 dark:bg-gray-900">
            ...
            <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="https://www.reshot.com/preview-assets/icons/CNDE2KHP3S/aerodynamic-plane-CNDE2KHP3S.svg" class="h-8" alt="AeroUrl Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Aero<span class="text-blue-500">URLs</span></span>
            </a>
